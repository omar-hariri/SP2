...
from src.models.xgb import build_xgb_model
...
def run(config: dict):
    ...
    model_config_path = config.get("model_config", "configs/models/xgb.yaml")
    ...
    print("=" * 60)
    print("Training XGBoost with Windows (Pipeline)")
    ...
    for window_cfg in windows:
        ...
        for fold_cfg in folds:
            ...
            # Save model locally
            models_dir = Path("artifacts/models/xgb")
